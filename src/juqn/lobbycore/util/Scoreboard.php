...
final class Scoreboard {
	...
	public function setLines(array $lines) : void {
		...
		$packet = SetScorePacket::create(SetScorePacket::TYPE_CHANGE, array_map(fn(int $id, string $value) => self::createLine($id, $value), array_keys($lines), array_values($lines)));
	...
	protected function spawn() : void {
		...
		$packet = SetDisplayObjectivePacket::create(SetDisplayObjectivePacket::DISPLAY_SLOT_SIDEBAR, self::OBJECTIVE_NAME, TextFormat::colorize($title), self::CRITERIA_NAME, SetDisplayObjectivePacket::SORT_ORDER_ASCENDING);
	...
	protected function despawn() : void {
		...
		$packet = RemoveObjectivePacket::create(self::OBJECTIVE_NAME);
